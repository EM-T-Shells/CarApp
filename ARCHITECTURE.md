...
└── carApp/                               # Expo app root
    ...
    │       ├── stripe-webhook/            # Payment engine (app-invoked, verify_jwt: true): intents, capture, refunds, accept/decline, cancel, no-show, Connect, payouts
